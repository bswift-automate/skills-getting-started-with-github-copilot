...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball training and interscholastic games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["james@mergington.edu", "lucas@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training, techniques, and competitive meets",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions and conduct research projects",
